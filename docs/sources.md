...
**Закон ДНР №141-РЗ** (18 December 2024) «О поддержке граждан, жилые помещения которых утрачены в результате боевых действий на территории Донецкой Народной Республики» — the base compensation-housing law amended by №269-РЗ above. Gates compensation to RF citizens who have written-renounced any other DNR-era support measure; requires the applicant to sign a formal "обязательство об отчуждении" surrendering the lost unit and its land to municipal ownership as a precondition of compensation; identifies the underlying federal accession statute as №5-ФКЗ (4 October 2022); transfers the compensation unit via the general Russian privatization mechanism (Закон РФ №1541-I); includes a false-information clawback clause. Source: <https://glavadnr.ru/doc/zakony/141rz.pdf>. **[CAPTURED] + READ 2026-07-09** — `scripts/285`, sha256 `dfa458c4a9965b...`. Cited in `docs/legal_mechanisms_review.md`.
