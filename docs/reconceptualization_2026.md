...
- **Filtration / entry-ban data:** ~1 in 4 allowed through (East SOS, via HRW); and — by **Russian authorities' own reporting** — 30,000 Ukrainians denied entry Oct 2023–Apr 2025 with 20–50-year bans (quoted in HRW, "Ukraine: Russia Illegally Seizing Property in Occupied Areas," 26 May 2026, captured `scripts/206`; the occupier's own figure, i.e. a self-incrimination number, not an NGO estimate). Evidence that the "appear in person within 30 days" requirement is *designed* to be impossible — central to proving the process is a sham. The same HRW report independently describes this project's exact seizure lifecycle and states HRW reviewed ~8,000 such court cases (Mar 2024–Jan 2026), and cites the UN that occupation authorities had flagged **>38,000 properties as "potentially abandoned" by Nov 2025** — external corroboration of the project's court corpus and registry scale.
