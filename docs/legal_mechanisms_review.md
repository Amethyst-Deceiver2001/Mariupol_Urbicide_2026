...
| **Mariupol municipal property-disposal rulebook — Распоряжение главы администрации г. Мариуполя №61 (03.11.2022)** «Об утверждении Временного порядка передачи в аренду имущества муниципальной собственности города Мариуполя, Временной методики расчета арендной платы…» | Governs how property that has become Mariupol municipal property — including stock entering via the ownerless pipeline above — is leased to legal entities, individuals and entrepreneurs, with its own rent-calculation methodology. The municipal-level operational bridge from [A] registry inclusion to downstream [D]/[F]/[G] reallocation/resale/housing. | [CITED] — verified 2026-06-12 on нпа.днронлайн.рф (`npa.dnronline.su` mirror, plain HTTP, no geoblock); registered Мариупольское горуправление юстиции №5351/14.11.2022, signed К.В. Иващенко; the page's PDF link (`doc.нпа.днронлайн.рф/.../RasporiazhAdminMariupol_N61_03112022.pdf`) is dead (host NXDOMAIN; bare-domain path also 404s, confirmed 2026-06-12) — likely a stale post-migration link, not a geoblock. As a *municipal* (not republic-level) decree it is out of scope for denis-pushilin.ru's Акты Главы ДНР archive (script 39), which only upgraded Указ №301 above. Still [CITED]-only; PDF recovery would need mariupol.gosuslugi.ru or the горуправление юстиции registry. |
