#!/usr/bin/env python3
"""Crawl the private Telegram chat at invite https://t.me/+ZPLyCLn2RItmNWMy.

Building identity unknown at script-authoring time — this invite hash has not
been resolved yet. Same pattern as scripts 89/93/101/103/105/107/109 (invite
...
Claude must never run this. Run from project root:
    .venv312/bin/python scripts/110_crawl_invite_ZPLyCLn2RItmNWMy.py
...
INVITE_HASH  = "ZPLyCLn2RItmNWMy"
CHANNEL_SLUG = "invite_ZPLyCLn2RItmNWMy"  # placeholder — rename once building is identified
BUILDING_NOTE = (
    "Residents' chat resolved from invite https://t.me/+ZPLyCLn2RItmNWMy. "
