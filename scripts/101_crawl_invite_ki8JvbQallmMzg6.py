#!/usr/bin/env python3
"""Crawl the private Telegram chat at invite https://t.me/+k-i8JvbQallmMzg6.

Building identity unknown at script-authoring time — this invite hash has not
been resolved yet. Same pattern as scripts 89/93 (invite hashes that resolved
to "Б-р Шевченко 77, 79" and "Меотиды 15/20" via the channel-migration
service message). After this chat is captured, check msg id=1 (or the
earliest MessageService with action._=="MessageActionChannelMigrateFrom")
for the group's original title — that's usually the building name.
...
Claude must never run this. Run from project root:
    .venv312/bin/python scripts/101_crawl_invite_ki8JvbQallmMzg6.py
...
INVITE_HASH  = "k-i8JvbQallmMzg6"
CHANNEL_SLUG = "invite_ki8JvbQallmMzg6"  # placeholder — rename once building is identified
BUILDING_NOTE = (
    "Residents' chat resolved from invite https://t.me/+k-i8JvbQallmMzg6. "
