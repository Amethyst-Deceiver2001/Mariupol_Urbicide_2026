#!/usr/bin/env python3
"""Crawl the private Telegram chat at invite https://t.me/+_jWgnL94O-dmYmMy.

Building identity unknown at script-authoring time — this invite hash has not
been resolved yet. Same pattern as scripts 89/93/101/103 (invite hashes
...
Claude must never run this. Run from project root:
    .venv312/bin/python scripts/105_crawl_invite_jWgnL94OdmYmMy.py
...
INVITE_HASH  = "_jWgnL94O-dmYmMy"
CHANNEL_SLUG = "invite_jWgnL94OdmYmMy"  # placeholder — rename once building is identified
BUILDING_NOTE = (
    "Residents' chat resolved from invite https://t.me/+_jWgnL94O-dmYmMy. "
