#!/usr/bin/env python3
"""Parse captured "Морской 20" Telegram messages.

'Морской' = informal name for б-р Комсомольский (dual-naming pattern, cf. scripts 98/108). pid=10714(д.20)/10715(д.20а), both demolished.

Run:
    python scripts/139_parse_komsomolskiy20_chat.py
"""
...
OUT          = ROOT / "data" / "parsed" / "komsomolskiy20_chat_signals.jsonl"
CHANNEL_SLUG = "invite_ZPLyCLn2RItmNWMy"
PIDS         = {10714: 10714, 10715: 10715}
...
def main():
    ...
    print(f"\n{'='*70}\n'Морской 20'  —  {len(rows)} messages parsed\n{'='*70}")
