#!/usr/bin/env python3
"""Parse captured "Пр. Победы 105, 103, 107/21 Межевая 19,15" Telegram messages.

Multi-building/multi-street chat: pid=5038(Победы105,none), 5303(Победы103,registry_inclusion), 5043(Победы107,none), 6832(Победы107/21,registry_inclusion), 5097(Межевая19,registry_inclusion), 5269(Межевая15,registry_inclusion).

Run:
    python scripts/142_parse_pobedy_mezhevaya_chat.py
"""
...
OUT          = ROOT / "data" / "parsed" / "pobedy_mezhevaya_chat_signals.jsonl"
CHANNEL_SLUG = "invite_gxgwA2by644ZTAy"
PIDS         = {5038: 5038, 5303: 5303, 5043: 5043, 6832: 6832, 5097: 5097, 5269: 5269}
...
def main():
    ...
    print(f"\n{'='*70}\n'Пр. Победы 105, 103, 107/21 Межевая 19,15'  —  {len(rows)} messages parsed\n{'='*70}")
