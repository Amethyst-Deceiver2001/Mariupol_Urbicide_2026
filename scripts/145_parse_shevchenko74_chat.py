#!/usr/bin/env python3
"""Parse captured "🛑Бул Шевченко 74🛑" Telegram messages.

pid=4399, бул. Шевченко 74, demolished. Crawled via script 116.

Run:
    python scripts/145_parse_shevchenko74_chat.py
"""
...
OUT          = ROOT / "data" / "parsed" / "shevchenko74_chat_signals.jsonl"
...
def main():
    ...
    print(f"\n{'='*70}\n'🛑Бул Шевченко 74🛑'  —  {len(rows)} messages parsed\n{'='*70}")
