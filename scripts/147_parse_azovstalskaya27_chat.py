#!/usr/bin/env python3
"""Parse captured "Азовстальская 27" Telegram messages.

pid=6258, ул. Азовстальская 27, demolished. Crawled via script 118. Distinct from pid=6259 (Azovstalskaya31 chat, scripts 74/76).

Run:
    python scripts/147_parse_azovstalskaya27_chat.py
"""
...
OUT          = ROOT / "data" / "parsed" / "azovstalskaya27_chat_signals.jsonl"
...
def main():
    ...
    print(f"\n{'='*70}\n'Азовстальская 27'  —  {len(rows)} messages parsed\n{'='*70}")
