#!/usr/bin/env python3
"""Crawl the private Telegram chat at invite https://t.me/+gx-gwA2by644ZTAy.

Building identity unknown at script-authoring time — this invite hash has not
been resolved yet. Same pattern as scripts 89/93/101/103/105/107/109/110/112
...
Date window capped at 2023-12-31 per user direction (later traffic not of
evidentiary interest for this chat).

Claude must never run this. Run from project root:
    .venv312/bin/python scripts/113_crawl_invite_gxgwA2by644ZTAy.py
...
INVITE_HASH  = "gx-gwA2by644ZTAy"
CHANNEL_SLUG = "invite_gxgwA2by644ZTAy"  # placeholder — rename once building is identified
BUILDING_NOTE = (
    "Residents' chat resolved from invite https://t.me/+gx-gwA2by644ZTAy. "
