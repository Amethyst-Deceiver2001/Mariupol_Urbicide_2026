#!/usr/bin/env python3
"""Parse captured "Хмельницкого 1/7, Бахчиванджи 5, Комсомолец" Telegram messages.

Multi-building chat. pid=10625 (Хмельницкого 1/7, demolished), pid=4780/4781/4782 (Бахчиванджи 5/5а/5б, no events yet).

Run:
    python scripts/136_parse_khmelnickogo1_7_bakhchivandzhi5_chat.py
"""
...
OUT          = ROOT / "data" / "parsed" / "khmelnickogo1_7_bakhchivandzhi5_chat_signals.jsonl"
CHANNEL_SLUG = "mariupol_komsomolets"
PIDS         = {10625: 10625, 4780: 4780, 4781: 4781, 4782: 4782}
...
def main():
    ...
    print(f"\n{'='*70}\n'Хмельницкого 1/7, Бахчиванджи 5, Комсомолец'  —  {len(rows)} messages parsed\n{'='*70}")
