#!/usr/bin/env python3
"""Crawl the private Telegram chat at invite https://t.me/+ooUT61cOOFZjMDcy.

Building identity unknown at script-authoring time — this invite hash has not
been resolved yet. Same pattern as scripts 89/93/101 (invite hashes that
resolved to "Б-р Шевченко 77, 79", "Меотиды 15/20" via the channel-migration
...
Claude must never run this. Run from project root:
    .venv312/bin/python scripts/103_crawl_invite_ooUT61cOOFZjMDcy.py
...
INVITE_HASH  = "ooUT61cOOFZjMDcy"
CHANNEL_SLUG = "invite_ooUT61cOOFZjMDcy"  # placeholder — rename once building is identified
BUILDING_NOTE = (
    "Residents' chat resolved from invite https://t.me/+ooUT61cOOFZjMDcy. "
