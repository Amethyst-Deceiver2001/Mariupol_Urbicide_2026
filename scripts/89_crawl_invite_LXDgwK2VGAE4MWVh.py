#!/usr/bin/env python3
"""Crawl the private Telegram chat at invite https://t.me/+LXDgwK2VGAE4MWVh.

Building identity unknown at script-authoring time — this invite hash has not
been resolved yet. First run will log the resolved chat title/id; update
CHANNEL_SLUG and BUILDING_NOTE below once known, then re-run script 90 (parser,
to be written after this chat's subject building is identified) against the
correct pid(s).
...
Claude must never run this. Run from project root:
    .venv312/bin/python scripts/89_crawl_invite_LXDgwK2VGAE4MWVh.py
...
INVITE_HASH  = "LXDgwK2VGAE4MWVh"
CHANNEL_SLUG = "invite_LXDgwK2VGAE4MWVh"  # placeholder — rename once building is identified
BUILDING_NOTE = (
    "Residents' chat resolved from invite https://t.me/+LXDgwK2VGAE4MWVh. "
    "Building/pid mapping NOT YET IDENTIFIED — review earliest messages and "
    "chat title after first capture to determine the subject building(s)."
)
