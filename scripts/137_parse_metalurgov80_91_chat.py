#!/usr/bin/env python3
"""Parse captured "Металлургов :80-91" Telegram messages.

Title implies a broader 80-91 range but spine only confirms pid=4550(89)/4551(91), both demolished, no reallocation yet.

Run:
    python scripts/137_parse_metalurgov80_91_chat.py
"""
...
OUT          = ROOT / "data" / "parsed" / "metalurgov80_91_chat_signals.jsonl"
CHANNEL_SLUG = "metalurgov89_91"
PIDS         = {4550: 4550, 4551: 4551}
...
def main():
    ...
    print(f"\n{'='*70}\n'Металлургов :80-91'  —  {len(rows)} messages parsed\n{'='*70}")
