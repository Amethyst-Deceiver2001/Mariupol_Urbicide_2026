#!/usr/bin/env python3
"""Scan @mrpl_ctzn -- text messages only, no media downloads.
...
Source-type: "telegram_mrplctzn_msg" (own namespace, independent resumability
...
foreign-state-adjacent service. Run from your own Russia-routed terminal:
    ...
    .venv312/bin/python scripts/338_crawl_mrpl_ctzn_text_only.py
    .venv312/bin/python scripts/338_crawl_mrpl_ctzn_text_only.py --backfill
...
NOTE = ("Mariupol citizen/resident channel -- already cited as a primary source elsewhere in this project (the Овсиенко compensation-via-bezkhoz quote, @mrpl_ctzn/15533, docs/legal_mechanisms_review.md) but never added to this project's chat corpus / KNOWN_CHANNELS. Surfaced again 2026-07-17 via telegram_global message-search hits (2 hits across the ЖК Нахимовский cluster sweep). "
