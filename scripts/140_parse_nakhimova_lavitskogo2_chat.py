#!/usr/bin/env python3
"""Parse captured "Нахимова 152, 154, 156 Лавицкого 3, 5" Telegram messages.

Multi-building chat on пр. Нахимова / ул. Лавицкого. pid=5842(Нахимова152,none), 5843(154,registry_inclusion), 5844(156,none), 5987(Лавицкого3,registry_inclusion), 5989(Лавицкого5,registry_inclusion).

Run:
    python scripts/140_parse_nakhimova_lavitskogo2_chat.py
"""
...
OUT          = ROOT / "data" / "parsed" / "nakhimova_lavitskogo2_chat_signals.jsonl"
CHANNEL_SLUG = "nahimova_lavitskogo"
PIDS         = {5842: 5842, 5843: 5843, 5844: 5844, 5987: 5987, 5989: 5989}
...
def main():
    ...
    print(f"\n{'='*70}\n'Нахимова 152, 154, 156 Лавицкого 3, 5'  —  {len(rows)} messages parsed\n{'='*70}")
