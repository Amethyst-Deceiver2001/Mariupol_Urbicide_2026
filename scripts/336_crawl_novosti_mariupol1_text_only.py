#!/usr/bin/env python3
"""Scan @novosti_mariupol1 -- text messages only, no media downloads.
...
Source-type: "telegram_novostimariupol1_msg" (own namespace, independent resumability
...
foreign-state-adjacent service. Run from your own Russia-routed terminal:
    ...
    .venv312/bin/python scripts/336_crawl_novosti_mariupol1_text_only.py
    .venv312/bin/python scripts/336_crawl_novosti_mariupol1_text_only.py --backfill
...
CHANNEL = "novosti_mariupol1"
SOURCE_TYPE = "telegram_novostimariupol1_msg"
NOTE = ("TASS-affiliated Mariupol news channel -- already cited as a primary source elsewhere in this project (the two TASS-sourced Моргун bezkhoz statements, docs/legal_mechanisms_review.md, captured 2026-07-08 as individual posts via scripts/282) but never added to this project's chat corpus / KNOWN_CHANNELS, so routine in-channel sweeps had been silently missing it. Surfaced again 2026-07-17 via telegram_global message-search hits (10 hits across the 4-address ЖК Нахимовский cluster sweep, mostly utility-outage notices) -- worth a full-history scan to catch further official statements this project has not yet found. "
