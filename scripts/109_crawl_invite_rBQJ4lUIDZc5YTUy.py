#!/usr/bin/env python3
"""Crawl the private Telegram chat at invite https://t.me/+rBQJ4lUIDZc5YTUy.

Building identity unknown at script-authoring time — this invite hash has not
been resolved yet. Same pattern as scripts 89/93/101/103/105/107 (invite
hashes resolved to "Б-р Шевченко 77, 79", "Меотиды 15/20", "Группа
...
Date window capped at 2022-12-31 per user direction (later traffic not of
evidentiary interest for this chat).

Claude must never run this. Run from project root:
    .venv312/bin/python scripts/109_crawl_invite_rBQJ4lUIDZc5YTUy.py
...
INVITE_HASH  = "rBQJ4lUIDZc5YTUy"
CHANNEL_SLUG = "invite_rBQJ4lUIDZc5YTUy"  # placeholder — rename once building is identified
BUILDING_NOTE = (
    "Residents' chat resolved from invite https://t.me/+rBQJ4lUIDZc5YTUy. "
