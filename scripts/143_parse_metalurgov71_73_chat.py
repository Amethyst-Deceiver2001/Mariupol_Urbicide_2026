#!/usr/bin/env python3
"""Parse captured "Металлургов 71,73" Telegram messages.

pid=4539(71,no events), 4540(73,registry_inclusion).

Run:
    python scripts/143_parse_metalurgov71_73_chat.py
"""
...
OUT          = ROOT / "data" / "parsed" / "metalurgov71_73_chat_signals.jsonl"
CHANNEL_SLUG = "metallgov"
PIDS         = {4539: 4539, 4540: 4540}
...
def main():
    ...
    print(f"\n{'='*70}\n'Металлургов 71,73'  —  {len(rows)} messages parsed\n{'='*70}")
