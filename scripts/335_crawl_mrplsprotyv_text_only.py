#!/usr/bin/env python3
"""Scan @mrplSprotyv -- text messages only, no media downloads.
...
Source-type: "telegram_mrplsprotyv_msg" (own namespace, independent resumability
...
foreign-state-adjacent service. Run from your own Russia-routed terminal:
    ...
    .venv312/bin/python scripts/335_crawl_mrplsprotyv_text_only.py
    .venv312/bin/python scripts/335_crawl_mrplsprotyv_text_only.py --backfill
...
NOTE = ("«мрпл Спротив» (occupation-resistance/victim-tracking channel) -- flagged 2026-07-17 during the ЖК Нахимовский cluster telegram_global sweep: surfaced a named-victim hit with an exact spine-address match (Быкова Ирина Степановна, улица Зелинского 17А, кв. неизвестна, 9-й этаж). "
        "Not previously part of this project's chat corpus (absent from src/mariupol_seizures/chat_buildings.py and every prior crawl target list). "
