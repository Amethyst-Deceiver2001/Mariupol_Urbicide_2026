#!/usr/bin/env python3
"""Crawl the private Telegram chat at invite https://t.me/+ucWZaRSL1Gk1NjRi.

Building identity unknown at script-authoring time — this invite hash has not
been resolved yet. Same pattern as scripts 89/93/101/103/105 (invite hashes
resolved to "Б-р Шевченко 77, 79", "Меотиды 15/20", "Группа БАХЧИВАНДЖИ
13-17" via the channel-migration service message). After this chat is
captured, check msg id=1 (or the earliest MessageService with
...
Claude must never run this. Run from project root:
    .venv312/bin/python scripts/107_crawl_invite_ucWZaRSL1Gk1NjRi.py
...
INVITE_HASH  = "ucWZaRSL1Gk1NjRi"
CHANNEL_SLUG = "invite_ucWZaRSL1Gk1NjRi"  # placeholder — rename once building is identified
BUILDING_NOTE = (
    "Residents' chat resolved from invite https://t.me/+ucWZaRSL1Gk1NjRi. "
