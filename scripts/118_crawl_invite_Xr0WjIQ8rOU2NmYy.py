#!/usr/bin/env python3
"""Crawl the private Telegram chat at invite https://t.me/+Xr0WjIQ8rOU2NmYy.

Resolved per user context: "Азовстальская 27".

One building on the property spine:
  ул. Азовстальская, 27  pid=6258  rd4u=A3.1,A3.6  demolition event on file

Demolished track. Distinct from the already-captured "Azovstalskaya31" chat
(scripts 74/76, pid=6259, ул. Азовстальская, 31) — same street, different
...
Claude must never run this. Run from project root:
    .venv312/bin/python scripts/118_crawl_invite_Xr0WjIQ8rOU2NmYy.py
...
INVITE_HASH  = "Xr0WjIQ8rOU2NmYy"
CHANNEL_SLUG = "invite_Xr0WjIQ8rOU2NmYy"
BUILDING_NOTE = (
    "Residents' chat resolved from invite https://t.me/+Xr0WjIQ8rOU2NmYy. "
    "ул. Азовстальская, 27, pid=6258, rd4u=A3.1,A3.6, demolition event on "
    "file. Demolished track. Distinct from Azovstalskaya31 chat (scripts "
    "74/76, pid=6259) — same street, different building."
)
