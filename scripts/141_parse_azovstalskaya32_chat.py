#!/usr/bin/env python3
"""Parse captured "Азовстальская 32" Telegram messages.

No exact 'Азовстальская, 32' match on spine despite extensive coverage of this street (45+ entries) -- a genuine numbering gap. Parsed without pid cross-reference; flags/signals only.

Run:
    python scripts/141_parse_azovstalskaya32_chat.py
"""
...
OUT          = ROOT / "data" / "parsed" / "azovstalskaya32_chat_signals.jsonl"
CHANNEL_SLUG = "invite_DCg6OyadlYYyYjc6"
PIDS         = {}
...
def main():
    ...
    print(f"\n{'='*70}\n'Азовстальская 32'  —  {len(rows)} messages parsed\n{'='*70}")
