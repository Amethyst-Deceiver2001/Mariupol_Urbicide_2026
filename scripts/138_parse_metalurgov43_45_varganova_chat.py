#!/usr/bin/env python3
"""Parse captured "Металлургов 43,45, Ленина (мира 71), Варганова 2,4" Telegram messages.

Multi-building/multi-street chat: pid=4527(Металлургов 43, no events), 4528(Металлургов 45/9, registry_inclusion), 4787(Варганова 2, registry_inclusion), 4789(Варганова 4, no events), 4472(Ленина 71/41, no events).

Run:
    python scripts/138_parse_metalurgov43_45_varganova_chat.py
"""
...
OUT          = ROOT / "data" / "parsed" / "metalurgov43_45_varganova_chat_signals.jsonl"
CHANNEL_SLUG = "invite_rBQJ4lUIDZc5YTUy"
PIDS         = {4527: 4527, 4528: 4528, 4787: 4787, 4789: 4789, 4472: 4472}
...
def main():
    ...
    print(f"\n{'='*70}\n'Металлургов 43,45, Ленина (мира 71), Варганова 2,4'  —  {len(rows)} messages parsed\n{'='*70}")
