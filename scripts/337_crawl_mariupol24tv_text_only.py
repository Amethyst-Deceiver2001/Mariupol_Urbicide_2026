#!/usr/bin/env python3
"""Scan @mariupol24tv -- text messages only, no media downloads.
...
Source-type: "telegram_mariupol24tv_msg" (own namespace, independent resumability
...
foreign-state-adjacent service. Run from your own Russia-routed terminal:
    ...
    .venv312/bin/python scripts/337_crawl_mariupol24tv_text_only.py
    .venv312/bin/python scripts/337_crawl_mariupol24tv_text_only.py --backfill
...
NOTE = ("Mariupol local-news TV channel -- already cited as a primary source elsewhere in this project (the 20.05.2025 Моргун bezkhoz statement, docs/legal_mechanisms_review.md, captured 2026-07-08 via scripts/282) but never added to this project's chat corpus / KNOWN_CHANNELS. Surfaced again 2026-07-17 via telegram_global message-search hits (7 hits across the ЖК Нахимовский cluster sweep). "
